...
const Main = () => {
  return (
    <div name='main' 
        className='h-screen w-full bg-gradient-to-b from-black to-gray-800 p-6 flex flex-col items-center gap-6 md:flex-row md:items-center'>
           {/* LEFT */}
                <div className='text-white mt-8 flex flex-col gap-6 mb-6 md:flex-1'>
