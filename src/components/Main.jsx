...
const Main = () => {
  return (
    <div name='main' 
        className='pl-20 h-screen w-full p-2 flex flex-col items-center gap-6 pt-24 md:flex-row md:items-center'>
           {/* LEFT */}
            ...
            {/* RIGHT */}
                <div className='flex items-center justify-center md:w-1/2'>
                    ...
                    alt=""
                    className='h-48 w-96 rounded-3xl md:h-72 md:w-128'
                     />
                </div>
            {/* RIGHT */}
    </div>
